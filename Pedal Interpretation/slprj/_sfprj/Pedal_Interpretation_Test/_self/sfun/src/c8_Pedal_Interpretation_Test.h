#ifndef __c8_Pedal_Interpretation_Test_h__
#define __c8_Pedal_Interpretation_Test_h__
...
typedef struct {
  ...
  uint8_T c8_is_active_c8_Pedal_Interpretation_Test;
  uint8_T c8_is_c8_Pedal_Interpretation_Test;
  uint8_T c8_tp_Init1;
  uint8_T c8_tp_Init2;
  uint8_T c8_tp_Init3;
  uint8_T c8_tp_Init4;
...
} SFc8_Pedal_Interpretation_TestInstanceStruct;
...
extern void sf_c8_Pedal_Interpretation_Test_get_check_sum(mxArray *plhs[]);
extern void c8_Pedal_Interpretation_Test_method_dispatcher(SimStruct *S, int_T
  method, void *data);
