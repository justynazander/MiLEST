...
static SFc8_Pedal_Interpretation_TestInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_Pedal_Interpretation_Test(void);
static void initialize_params_c8_Pedal_Interpretation_Test(void);
static void enable_c8_Pedal_Interpretation_Test(void);
static void disable_c8_Pedal_Interpretation_Test(void);
static void update_debugger_state_c8_Pedal_Interpretation_Test(void);
static const mxArray *get_sim_state_c8_Pedal_Interpretation_Test(void);
static void set_sim_state_c8_Pedal_Interpretation_Test(const mxArray *c8_st);
static void finalize_c8_Pedal_Interpretation_Test(void);
static void sf_c8_Pedal_Interpretation_Test(void);
static void c8_chartstep_c8_Pedal_Interpretation_Test(void);
...
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static uint8_T c8_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name);
static real_T c8_b_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name);
static uint16_T c8_c_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name);
static const mxArray *c8_emlrt_marshallOut(uint8_T c8_u);
static const mxArray *c8_b_emlrt_marshallOut(real_T c8_u);
static const mxArray *c8_c_emlrt_marshallOut(uint16_T c8_u);
...
static void initialize_c8_Pedal_Interpretation_Test(void)
{
  ...
  chartInstance.c8_is_active_c8_Pedal_Interpretation_Test = 0U;
  chartInstance.c8_is_c8_Pedal_Interpretation_Test = 0U;
...
static void update_debugger_state_c8_Pedal_Interpretation_Test(void)
{
  ...
  if (chartInstance.c8_is_active_c8_Pedal_Interpretation_Test == 1) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition1) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_wait) {
    _SFD_CS_CALL(STATE_ACTIVE_TAG,24);
  } else {
    _SFD_CS_CALL(STATE_INACTIVE_TAG,24);
  }

  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition2) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition3) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition4) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition5) {
  ...
  if (chartInstance.c8_is_c8_Pedal_Interpretation_Test == c8_IN_Precondition6) {
...
static const mxArray *get_sim_state_c8_Pedal_Interpretation_Test(void)
{
  ...
  c8_st = NULL;
  c8_y = NULL;
  sf_mex_assign(&c8_y, sf_mex_createcellarray(35));
  sf_mex_setcell(c8_y, 0, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre1));
  sf_mex_setcell(c8_y, 1, c8_emlrt_marshallOut(chartInstance.c8_tp_Init1));
  sf_mex_setcell(c8_y, 2, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise1));
  sf_mex_setcell(c8_y, 3, c8_emlrt_marshallOut(chartInstance.c8_tp_Precondition1));
  sf_mex_setcell(c8_y, 4, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise6));
  sf_mex_setcell(c8_y, 5, c8_emlrt_marshallOut(chartInstance.c8_tp_wait));
  sf_mex_setcell(c8_y, 6, c8_emlrt_marshallOut(chartInstance.c8_tp_Precondition2));
  sf_mex_setcell(c8_y, 7, c8_emlrt_marshallOut(chartInstance.c8_tp_Init2));
  sf_mex_setcell(c8_y, 8, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre2));
  sf_mex_setcell(c8_y, 9, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise2));
  sf_mex_setcell(c8_y, 10, c8_emlrt_marshallOut
                 (chartInstance.c8_tp_Precondition3));
  sf_mex_setcell(c8_y, 11, c8_emlrt_marshallOut(chartInstance.c8_tp_Init3));
  sf_mex_setcell(c8_y, 12, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre3));
  sf_mex_setcell(c8_y, 13, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise3));
  sf_mex_setcell(c8_y, 14, c8_emlrt_marshallOut
                 (chartInstance.c8_tp_Precondition4));
  sf_mex_setcell(c8_y, 15, c8_emlrt_marshallOut(chartInstance.c8_tp_Init4));
  sf_mex_setcell(c8_y, 16, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre4));
  sf_mex_setcell(c8_y, 17, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise4));
  sf_mex_setcell(c8_y, 18, c8_emlrt_marshallOut
                 (chartInstance.c8_tp_Precondition5));
  sf_mex_setcell(c8_y, 19, c8_emlrt_marshallOut(chartInstance.c8_tp_Init5));
  sf_mex_setcell(c8_y, 20, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre5));
  sf_mex_setcell(c8_y, 21, c8_emlrt_marshallOut(chartInstance.c8_tp_Stabilise5));
  sf_mex_setcell(c8_y, 22, c8_emlrt_marshallOut
                 (chartInstance.c8_tp_Precondition6));
  sf_mex_setcell(c8_y, 23, c8_emlrt_marshallOut(chartInstance.c8_tp_Init6));
  sf_mex_setcell(c8_y, 24, c8_emlrt_marshallOut(chartInstance.c8_tp_TDataPre6));
  sf_mex_setcell(c8_y, 25, c8_emlrt_marshallOut
                 (chartInstance.c8_is_active_c8_Pedal_Interpretation_Test));
  sf_mex_setcell(c8_y, 26, c8_emlrt_marshallOut
                 (chartInstance.c8_is_c8_Pedal_Interpretation_Test));
  sf_mex_setcell(c8_y, 27, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition1));
  sf_mex_setcell(c8_y, 28, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition2));
  sf_mex_setcell(c8_y, 29, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition3));
  sf_mex_setcell(c8_y, 30, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition4));
  sf_mex_setcell(c8_y, 31, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition5));
  sf_mex_setcell(c8_y, 32, c8_emlrt_marshallOut
                 (chartInstance.c8_is_Precondition6));
  sf_mex_setcell(c8_y, 33, c8_b_emlrt_marshallOut(*c8_TDPre));
  sf_mex_setcell(c8_y, 34, c8_c_emlrt_marshallOut
...
static void set_sim_state_c8_Pedal_Interpretation_Test(const mxArray *c8_st)
{
  ...
  chartInstance.c8_tp_TDataPre1 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 0)), "tp_TDataPre1");
  chartInstance.c8_tp_Init1 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    1)), "tp_Init1");
  chartInstance.c8_tp_Stabilise1 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 2)), "tp_Stabilise1");
  chartInstance.c8_tp_Precondition1 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 3)), "tp_Precondition1");
  chartInstance.c8_tp_Stabilise6 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 4)), "tp_Stabilise6");
  chartInstance.c8_tp_wait = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    5)), "tp_wait");
  chartInstance.c8_tp_Precondition2 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 6)), "tp_Precondition2");
  chartInstance.c8_tp_Init2 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    7)), "tp_Init2");
  chartInstance.c8_tp_TDataPre2 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 8)), "tp_TDataPre2");
  chartInstance.c8_tp_Stabilise2 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 9)), "tp_Stabilise2");
  chartInstance.c8_tp_Precondition3 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 10)), "tp_Precondition3");
  chartInstance.c8_tp_Init3 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    11)), "tp_Init3");
  chartInstance.c8_tp_TDataPre3 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 12)), "tp_TDataPre3");
  chartInstance.c8_tp_Stabilise3 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 13)), "tp_Stabilise3");
  chartInstance.c8_tp_Precondition4 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 14)), "tp_Precondition4");
  chartInstance.c8_tp_Init4 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    15)), "tp_Init4");
  chartInstance.c8_tp_TDataPre4 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 16)), "tp_TDataPre4");
  chartInstance.c8_tp_Stabilise4 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 17)), "tp_Stabilise4");
  chartInstance.c8_tp_Precondition5 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 18)), "tp_Precondition5");
  chartInstance.c8_tp_Init5 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    19)), "tp_Init5");
  chartInstance.c8_tp_TDataPre5 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 20)), "tp_TDataPre5");
  chartInstance.c8_tp_Stabilise5 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 21)), "tp_Stabilise5");
  chartInstance.c8_tp_Precondition6 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 22)), "tp_Precondition6");
  chartInstance.c8_tp_Init6 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u,
    23)), "tp_Init6");
  chartInstance.c8_tp_TDataPre6 = c8_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell
    (c8_u, 24)), "tp_TDataPre6");
  chartInstance.c8_is_active_c8_Pedal_Interpretation_Test = c8_emlrt_marshallIn
    (sf_mex_dup(sf_mex_getcell(c8_u, 25)),
     "is_active_c8_Pedal_Interpretation_Test");
  chartInstance.c8_is_c8_Pedal_Interpretation_Test = c8_emlrt_marshallIn
    (sf_mex_dup(sf_mex_getcell(c8_u, 26)),
     "is_c8_Pedal_Interpretation_Test");
  chartInstance.c8_is_Precondition1 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 27)), "is_Precondition1");
  chartInstance.c8_is_Precondition2 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 28)), "is_Precondition2");
  chartInstance.c8_is_Precondition3 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 29)), "is_Precondition3");
  chartInstance.c8_is_Precondition4 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 30)), "is_Precondition4");
  chartInstance.c8_is_Precondition5 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 31)), "is_Precondition5");
  chartInstance.c8_is_Precondition6 = c8_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 32)), "is_Precondition6");
  *c8_TDPre = c8_b_emlrt_marshallIn(sf_mex_dup(sf_mex_getcell(c8_u, 33)),
    "TDPre");
  chartInstance.c8_temporalCounter_i1 = c8_c_emlrt_marshallIn(sf_mex_dup
    (sf_mex_getcell(c8_u, 34)), "temporalCounter_i1");
  sf_mex_destroy(&c8_u);
  update_debugger_state_c8_Pedal_Interpretation_Test();
...
static void sf_c8_Pedal_Interpretation_Test(void)
{
  ...
  c8_chartstep_c8_Pedal_Interpretation_Test();
...
static void c8_chartstep_c8_Pedal_Interpretation_Test(void)
{
  ...
  if (chartInstance.c8_is_active_c8_Pedal_Interpretation_Test == 0) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG,4);
    chartInstance.c8_is_active_c8_Pedal_Interpretation_Test = 1U;
    _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,4);
    _SFD_CT_CALL(TRANSITION_BEFORE_PROCESSING_TAG,0);
    _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,0);
    chartInstance.c8_is_c8_Pedal_Interpretation_Test = (uint8_T)c8_IN_wait;
    _SFD_CS_CALL(STATE_ACTIVE_TAG,24);
    ...
    *c8_TDPre = 7.0;
    ...
    switch (chartInstance.c8_is_c8_Pedal_Interpretation_Test) {
      ...
      switch (chartInstance.c8_is_Precondition5) {
       ...
       case c8_IN_Stabilise5:
        ...
        if (CV_TRANSITION_EVAL(15U, (_SFD_CCP_CALL(15,0,((1)!=0)) != 0) &&
          ...
          chartInstance.c8_is_c8_Pedal_Interpretation_Test = (uint8_T)
            c8_IN_Precondition6;
          _SFD_CS_CALL(STATE_ACTIVE_TAG,20);
...
const mxArray *sf_c8_Pedal_Interpretation_Test_get_eml_resolved_functions_info
  (void)
{
...
static uint8_T c8_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name)
{
  uint8_T c8_y;
  uint8_T c8_u0;
  sf_mex_import(c8_name, sf_mex_dup(c8_temporary), &c8_u0, 1, 3, 0U, 0, 0U, 0);
  c8_y = c8_u0;
  sf_mex_destroy(&c8_temporary);
  return c8_y;
}
...
static real_T c8_b_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name)
{
  real_T c8_y;
  real_T c8_d0;
  sf_mex_import(c8_name, sf_mex_dup(c8_temporary), &c8_d0, 1, 0, 0U, 0, 0U, 0);
  c8_y = c8_d0;
  sf_mex_destroy(&c8_temporary);
  return c8_y;
}
...
static uint16_T c8_c_emlrt_marshallIn(const mxArray *c8_temporary, char *c8_name)
{
  uint16_T c8_y;
  uint16_T c8_u1;
  sf_mex_import(c8_name, sf_mex_dup(c8_temporary), &c8_u1, 1, 5, 0U, 0, 0U, 0);
  c8_y = c8_u1;
  sf_mex_destroy(&c8_temporary);
  return c8_y;
}
...
void sf_c8_Pedal_Interpretation_Test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_Pedal_Interpretation_Test_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c8_Pedal_Interpretation_Test();
  initialize_c8_Pedal_Interpretation_Test();
}

static void sf_opaque_enable_c8_Pedal_Interpretation_Test(void *chartInstanceVar)
{
  enable_c8_Pedal_Interpretation_Test();
}

static void sf_opaque_disable_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar)
{
  disable_c8_Pedal_Interpretation_Test();
}

static void sf_opaque_gateway_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar)
{
  sf_c8_Pedal_Interpretation_Test();
}

static mxArray* sf_opaque_get_sim_state_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c8_Pedal_Interpretation_Test();
  return st;
}

static void sf_opaque_set_sim_state_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c8_Pedal_Interpretation_Test(sf_mex_dup(st));
}

static void sf_opaque_terminate_c8_Pedal_Interpretation_Test(void
  *chartInstanceVar)
{
  ...
  finalize_c8_Pedal_Interpretation_Test();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_Pedal_Interpretation_Test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_Pedal_Interpretation_Test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("Pedal_Interpretation_Test",
      "Pedal_Interpretation_Test",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("Pedal_Interpretation_Test",
                "Pedal_Interpretation_Test",8,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(
      "Pedal_Interpretation_Test","Pedal_Interpretation_Test",8,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"Pedal_Interpretation_Test",
        "Pedal_Interpretation_Test",8,5);
      sf_mark_chart_reusable_outputs(S,"Pedal_Interpretation_Test",
        "Pedal_Interpretation_Test",8,1);
    }
...
static void mdlRTW_c8_Pedal_Interpretation_Test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_Pedal_Interpretation_Test(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 0;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_Pedal_Interpretation_Test;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_Pedal_Interpretation_Test;
...
void c8_Pedal_Interpretation_Test_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_Pedal_Interpretation_Test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_Pedal_Interpretation_Test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_Pedal_Interpretation_Test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_Pedal_Interpretation_Test_method_dispatcher.\n"
