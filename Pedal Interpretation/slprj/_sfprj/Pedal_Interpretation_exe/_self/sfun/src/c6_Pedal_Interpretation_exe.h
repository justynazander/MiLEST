#ifndef __c6_Pedal_Interpretation_exe_h__
#define __c6_Pedal_Interpretation_exe_h__
...
typedef struct {
  ...
  uint8_T c6_is_active_c6_Pedal_Interpretation_exe;
  uint8_T c6_is_c6_Pedal_Interpretation_exe;
  uint8_T c6_tp_Init1;
  uint8_T c6_tp_Init2;
...
} SFc6_Pedal_Interpretation_exeInstanceStruct;
...
extern void sf_c6_Pedal_Interpretation_exe_get_check_sum(mxArray *plhs[]);
extern void c6_Pedal_Interpretation_exe_method_dispatcher(SimStruct *S, int_T
  method, void *data);
