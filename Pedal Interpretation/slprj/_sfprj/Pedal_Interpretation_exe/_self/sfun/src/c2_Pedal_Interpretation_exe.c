...
static SFc2_Pedal_Interpretation_exeInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_Pedal_Interpretation_exe(void);
static void initialize_params_c2_Pedal_Interpretation_exe(void);
static void enable_c2_Pedal_Interpretation_exe(void);
static void disable_c2_Pedal_Interpretation_exe(void);
static void update_debugger_state_c2_Pedal_Interpretation_exe(void);
static const mxArray *get_sim_state_c2_Pedal_Interpretation_exe(void);
static void set_sim_state_c2_Pedal_Interpretation_exe(const mxArray *c2_st);
static void finalize_c2_Pedal_Interpretation_exe(void);
...
void sf_c2_Pedal_Interpretation_exe_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_Pedal_Interpretation_exe_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_Pedal_Interpretation_exe(void
  *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_Pedal_Interpretation_exe();
  initialize_c2_Pedal_Interpretation_exe();
}

static void sf_opaque_enable_c2_Pedal_Interpretation_exe(void *chartInstanceVar)
{
  enable_c2_Pedal_Interpretation_exe();
}

static void sf_opaque_disable_c2_Pedal_Interpretation_exe(void *chartInstanceVar)
{
  disable_c2_Pedal_Interpretation_exe();
}

static void sf_opaque_gateway_c2_Pedal_Interpretation_exe(void *chartInstanceVar)
{
  sf_c2_Pedal_Interpretation_exe();
}

static mxArray* sf_opaque_get_sim_state_c2_Pedal_Interpretation_exe(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_Pedal_Interpretation_exe();
  return st;
}

static void sf_opaque_set_sim_state_c2_Pedal_Interpretation_exe(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c2_Pedal_Interpretation_exe(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_Pedal_Interpretation_exe(void
  *chartInstanceVar)
{
  ...
  finalize_c2_Pedal_Interpretation_exe();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Pedal_Interpretation_exe(SimStruct *S)
{
  int i;
...
static void mdlRTW_c2_Pedal_Interpretation_exe(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Pedal_Interpretation_exe(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 0;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_Pedal_Interpretation_exe;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Pedal_Interpretation_exe;
...
void c2_Pedal_Interpretation_exe_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Pedal_Interpretation_exe(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Pedal_Interpretation_exe(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Pedal_Interpretation_exe(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Pedal_Interpretation_exe_method_dispatcher.\n"
